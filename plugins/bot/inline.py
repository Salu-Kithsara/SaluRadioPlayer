...
buttons = [
            ...
            [
                InlineKeyboardButton("🤖 MAKE YOUR OWN BOT 🤖", url="https://heroku.com/deploy?template=https://github.com/Salu-Kithsara/SaluRadioPlayer"),
            ]
         ]
    ...
    if query.query == "SAF_ONE":
        answers.append(
            InlineQueryResultPhoto(
                ...
                thumb_url="https://telegra.ph/file/a3755d9cb09f1361e3ac7.jpg",
                photo_url="https://telegra.ph/file/a3755d9cb09f1361e3ac7.jpg",
                caption=f"{REPLY_MESSAGE}\n\n<b>© Powered By : \n@OUTBOX_Offlicial | @OUTBOXTeam_Offlicial 👑</b>",
